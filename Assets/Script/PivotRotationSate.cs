...
public class PivotRotationSate : MonoBehaviour
{
    ...
    private void SpinSide()
    {
        ...
        if (cubeState.front.Contains(face))//click front side
        {
            for (int i = 0; i < 9; i++)
            {
                if (face == cubeState.front[i])
                {
                    if (i == 4)
                    {
        ...
        if (cubeState.right.Contains(face))//click front side
        {
            for (int i = 0; i < 9; i++)
            {
                if (face == cubeState.right[i])
                {
                    if (i == 4)
                    {
                        cubeState.PickUp(cubeState.right);
        ...
        if (cubeState.up.Contains(face))//click front side
        {
            for (int i = 0; i < 9; i++)
            {
